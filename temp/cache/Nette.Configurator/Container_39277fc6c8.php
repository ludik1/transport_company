<?php
// source: C:\xampp\htdocs\TransportCompany\app/config/config.neon development
// source: C:\xampp\htdocs\TransportCompany\app/config/config.local.neon 

class Container_39277fc6c8 extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			...
			'Dibi\Connection' => array(1 => array('dibi.connection')),
			'Tracy\IBarPanel' => array(1 => array('dibi.panel')),
			'Dibi\Bridges\Tracy\Panel' => array(1 => array('dibi.panel')),
			'Models\BaseModel' => array(
				1 => array(
					'carsModel',
					'productsModel',
					'userRolesModel',
			...
			'Models\CarsModel' => array(1 => array('carsModel')),
			'Models\ProductsModel' => array(1 => array('productsModel')),
			'Models\UserRolesModel' => array(1 => array('userRolesModel')),
			'Models\UsersModel' => array(1 => array('usersModel')),
			'Nette\Security\IAuthenticator' => array(1 => array('authenticator')),
			'FRI\User\Authenticator' => array(1 => array('authenticator')),
			...
			'App\AdminModule\Presenters\CarPresenter' => array(array('application.1')),
			'App\AdminModule\Presenters\HomepagePresenter' => array(array('application.2')),
			'App\AdminModule\Presenters\ProductPresenter' => array(array('application.3')),
			'App\AdminModule\Presenters\UserPresenter' => array(array('application.4')),
			'App\FrontModule\Presenters\BasePresenter' => array(array('application.5')),
			'App\FrontModule\Presenters\AuthPresenter' => array(array('application.5')),
			'App\Presenters\BasePresenter' => array(array('application.6')),
			'App\Presenters\Error4xxPresenter' => array(array('application.6')),
			'App\Presenters\ErrorPresenter' => array(array('application.7')),
		...
		'services' => array(
			'application.1' => 'App\AdminModule\Presenters\CarPresenter',
			'application.2' => 'App\AdminModule\Presenters\HomepagePresenter',
			'application.3' => 'App\AdminModule\Presenters\ProductPresenter',
			'application.4' => 'App\AdminModule\Presenters\UserPresenter',
			'application.5' => 'App\FrontModule\Presenters\AuthPresenter',
			'application.6' => 'App\Presenters\Error4xxPresenter',
			'application.7' => 'App\Presenters\ErrorPresenter',
			'application.8' => 'NetteModule\ErrorPresenter',
			'application.9' => 'NetteModule\MicroPresenter',
			'application.application' => 'Nette\Application\Application',
			'application.linkGenerator' => 'Nette\Application\LinkGenerator',
			'application.presenterFactory' => 'Nette\Application\IPresenterFactory',
			'authenticator' => 'FRI\User\Authenticator',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\xampp\htdocs\TransportCompany\app',
			'wwwDir' => 'C:\xampp\htdocs\TransportCompany\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'C:\xampp\htdocs\TransportCompany\app/../temp',
			'router' => array('secured' => TRUE),
		));
	}


	/**
	 * @return App\AdminModule\Presenters\CarPresenter
	 */
	public function createServiceApplication__1()
	{
		$service = new App\AdminModule\Presenters\CarPresenter($this->getService('carsModel'));
	...
	{
		$service = new App\AdminModule\Presenters\ProductPresenter($this->getService('productsModel'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->invalidLinkMode = 5;
	...
	{
		$service = new App\AdminModule\Presenters\UserPresenter($this->getService('usersModel'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->invalidLinkMode = 5;
	...
	/**
	 * @return App\FrontModule\Presenters\AuthPresenter
	 */
	public function createServiceApplication__5()
	{
		$service = new App\FrontModule\Presenters\AuthPresenter($this->getService('usersModel'), $this->getService('userRolesModel'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->invalidLinkMode = 5;
	...
	/**
	 * @return FRI\User\Authenticator
	 */
	public function createServiceAuthenticator()
	{
		$service = new FRI\User\Authenticator($this->getService('usersModel'), $this->getService('userRolesModel'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\xampp\htdocs\TransportCompany\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\TransportCompany\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}


	/**
	 * @return Models\CarsModel
	 */
	public function createServiceCarsModel()
	{
		$service = new Models\CarsModel($this->getService('dibi.connection'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=transport_company', NULL, NULL, array('lazy' => TRUE));
	...
	public function createServiceDibi__connection()
	{
		...
		Tracy\Debugger::getBlueScreen()->addPanel(array(
			'Dibi\Bridges\Tracy\Panel',
			'renderException',
		));
		$this->getService('dibi.panel')->register($service);
		return $service;
	}
	...
	{
		$service = new Dibi\Bridges\Tracy\Panel(TRUE, 60);
		return $service;
	}
	...
	{
		return new Container_39277fc6c8_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	 ...
	 */
	public function createServiceProductsModel()
	{
		$service = new Models\ProductsModel($this->getService('dibi.connection'));
		return $service;
	}
	...
	{
		$service = App\Router\RouterFactory::createRouter(TRUE);
	...
	/**
	 * @return Models\UserRolesModel
	 */
	public function createServiceUserRolesModel()
	{
		$service = new Models\UserRolesModel($this->getService('dibi.connection'));
		return $service;
	}
	 ...
	 */
	public function createServiceUsersModel()
	{
		$service = new Models\UsersModel($this->getService('dibi.connection'));
		return $service;
	}
...
final class Container_39277fc6c8_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_39277fc6c8 $container)
	{
