<?php
// source: C:\xampp\htdocs\TransportCompany\app\AdminModule/templates/Car/addDriver.latte

class Template6440f277bff4785d13d28e99095d9914 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('4456b62faa', 'html')
;
...
<?php $_l->tmp = $_control->getComponent("driverForm"); if ($_l->tmp instanceof Nette\Application\UI\IRenderable) $_l->tmp->redrawControl(NULL, FALSE); $_l->tmp->render() ?>
</div><?php
}}