<?php
// source: C:\xampp\htdocs\TransportCompany\app\AdminModule/templates/Car/default.latte

class Template6374bbce6d81ed0817659402bce83192 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('136d8e4ee7', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbd7ca39d52e_content')) { function _lbd7ca39d52e_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>	<div style="padding-top: 30px; width: 80%; margin:0 auto;">
<?php $_l->tmp = $_control->getComponent("carsGrid"); if ($_l->tmp instanceof Nette\Application\UI\IRenderable) $_l->tmp->redrawControl(NULL, FALSE); $_l->tmp->render() ?>
	</div>
<?php
}}
...
">Užívatelia</a></li>
   <li class='active has-sub'><a href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link(":Admin:Car:default"), ENT_COMPAT) ?>
">Vozidlá</a></li>
...
<a href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link(":Admin:Car:add"), ENT_COMPAT) ?>
"><span>Pridať vozidlo</span></a>
