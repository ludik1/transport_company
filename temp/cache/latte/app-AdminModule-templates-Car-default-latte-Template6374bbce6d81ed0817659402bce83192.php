...
<?php $iterations++; } ?>
<a class="button" href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link(":Admin:Car:add"), ENT_COMPAT) ?>
">Pridať vozidlo</a>
<a class="button" href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link(":Admin:Car:addDriver"), ENT_COMPAT) ?>
">Pridať šoféra</a>
