...
Nette.validators.AppAdminModuleFormsProductFormRules_validateDate = function (elem, arg, value) {
	alert('sdffgsd');
};
Nette.validators.FormsProductFormRules_validateDate = function (elem, args, val) {
	alert('dfgdf');
	};
/**
